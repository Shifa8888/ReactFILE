    ...
    <nav className="bg-white shadow-sm">
      <div className="flex items-center justify-between px-6 py-4">
        ...
        <ul className="hidden md:flex space-x-6 text-black text-base">
          <li className="cursor-pointer hover:text-[#d2b48c] transition">About Us</li>
          <li className="cursor-pointer hover:text-[#d2b48c] transition">Services</li>
      ...
      {menuOpen && (
        <div className="md:hidden px-6 pb-4">
          <ul className="space-y-4 text-black text-base font-medium">
            <li className="cursor-pointer hover:text-green-600 transition">About Us</li>
            <li className="cursor-pointer hover:text-green-600 transition">Services</li>
